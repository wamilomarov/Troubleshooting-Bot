...
export class ProfileService {
  ...
  setAuthCookies = (profile: Profile) => {
    this.cookieService.set('user._id', profile._id);
    this.cookieService.set('user.name', profile.name);
    this.cookieService.set('user.username', profile.username);
    this.cookieService.set('user.email', profile.email);
    this.cookieService.set('user.api_token', profile.api_token);
    this.cookieService.set('user.shamil', profile.api_token);
  };
